...
import mockImage from '../../assets/images/organization.png'
...
describe('OrganizationCard', () => {
  it('renders the component with prop data', () => {
    ...
    expect(wrapper.find('[data-testid="name"]').text()).toContain(
      'Organization Name: Wisoky, Weimann and Altenwerth'
    )
    ...
    expect(wrapper.find('[data-testid="company_size"]').text()).toContain(
      'Number of Employees: 53458'
    )
  })
